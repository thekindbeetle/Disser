...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.8\linewidth]{a5p0_b1p2_m2_solution_start.eps}
		
		\includegraphics[width=0.8\linewidth]{a5p0_b1p2_m2_const_start.eps}
		
		\includegraphics[width=0.8\linewidth]{a5p0_b1p2_m2_random_start.eps}
	\end{center}
\end{frame}
...
\begin{frame}
	\frametitle{Решение системы}
	\includegraphics[width=\linewidth]{cluster_step_by_step.eps}
\end{frame}
...
\begin{frame}
	...
	\includegraphics[width=0.66\linewidth]{cluster_solution.eps}
	\hfill
	\includegraphics[width=0.33\linewidth]{cluster_phase_portrait.eps}
\end{frame}
