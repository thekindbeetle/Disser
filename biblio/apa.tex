...
\newbibmacro*{journal+issuetitle}{%
  \mkbibemph{\iffieldundef{origjournal}
  {\usebibmacro{journal}}
  {\printfield{origjournal}%
  	\setunit{\addspace}%
  	\printtext[brackets]{\usebibmacro{journal}}}}%
  \setunit*{\addcomma\addspace}%
  \iffieldundef{series}
    {}
    {\newunit
...
\newcommand{\printbibliographyapa}[1][]{
\normalfont
\global\settoggle{bbx:apastyle}{true}
\csdef{blx@beglangcite}{}
\csdef{blx@beglangbib}{}
